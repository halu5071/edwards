...
public class PointEd25519Benchmark {
    ...
    private Point point = new PointEd25519(
            ...
            new CoordinateEd25519(BigInteger.ONE),
            new CoordinateEd25519(new BigInteger("20266806181347897178517736945403300566236311925948585575972021784256181966831").multiply(new BigInteger("20852410506957026626210500909507772892959249564214740554270305643381675686982"))).mod()
    );
