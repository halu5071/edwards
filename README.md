...
## How to build
Please use AndroidStudio or Intellij.

### 1. Clone this repository

```
$ git clone git@github.com:halu5071/edwards.git
$ cd edwards
```

### 2. Set up native test.
Please prepare `cmake`, `make` and C++ compiler, and run commands as below.
