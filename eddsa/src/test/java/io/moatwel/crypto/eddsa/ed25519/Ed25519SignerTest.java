...
public class Ed25519SignerTest {
    ...
    public void success_SignMessage_2() {
        ...
        assertThat(S2, is(new BigInteger("319146615599574595135908926944340520491598694492366832960461172005503422390")));
    }
    ...
    public void success_SignMessage_4() {
        ...
        assertThat(S2, is(new BigInteger("2252310211898356742998600270025710650492586984677205696869814236970115197278")));
    }
    ...
    public void success_SignMessage_7() {
        ...
        assertThat(S2, is(new BigInteger("4105090635616705429695061053659558245554003651275941563464146285782036767247")));
    }
    ...
    public void success_SignMessage_8() {
        ...
        assertThat(S2, is(new BigInteger("1604647941269107468368228687487870742511952935958022539608874018737074330319")));
    }
    ...
    public void success_SignMessage_9() {
        ...
        assertThat(S2, is(new BigInteger("5963041987263877244708113770479269232811306164634722801487290783357877935551")));
    }
    ...
    public void success_SignMessage_10() {
        ...
        assertThat(S2, is(new BigInteger("848154976076826618610609638126270980845883908127446877491542198494102319298")));
    }
    ...
    public void success_SignMessage_13() {
        ...
        assertThat(S2, is(new BigInteger("7106801270362525235591996847494922622272138280983580979375970532026670675584")));
    }
    ...
    public void success_SignMessage_14() {
        ...
        assertThat(S2, is(new BigInteger("5069138128228814385089001217078374320204635670412237807821416353815958382331")));
    }
