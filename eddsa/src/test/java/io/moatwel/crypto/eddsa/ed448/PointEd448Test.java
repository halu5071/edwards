...
public class PointEd448Test {
    ...
    public void success_AddPoint_Origin() {
        ...
        assertThat(result.getX().getInteger(), is(new BigInteger("49729590024926883705949292896832095905118054184233662910554366985450733984769365837664107636334549191842981597231441932614315886910607")));
        assertThat(result.getY().getInteger(), is(new BigInteger("193741900868621819975499372099647484535272271429894036976062361471930494363363247663029822163982750251639381039128810944511255901134101")));
    }
    ...
    public void success_ScalarMultipleBasePoint_2() {
        ...
        assertThat(point.getX().getInteger(), is(new BigInteger("484559149530404593699549205258669689569094240458212040187660132787056912146709081364401144455726350866276831544947397859048262938744149")));
        assertThat(point.getY().getInteger(), is(new BigInteger("494088759867433727674302672526735089350544552303727723746126484473087719117037293890093462157703888342865036477787453078312060500281069")));
    }
    ...
    public void success_ScalarMultipleBasePoint_3() {
        ...
        assertThat(point.getX().getInteger(), is(new BigInteger("23839778817283171003887799738662344287085130522697782688245073320169861206004018274567429238677677920280078599146891901463786155880335")));
        assertThat(point.getY().getInteger(), is(new BigInteger("636046652612779686502873775776967954190574036985351036782021535703553242737829645273154208057988851307101009474686328623630835377952508")));
    }
    ...
    public void success_ScalarMultipleBasePoint_7() {
        ...
        assertThat(point.getX().getInteger(), is(new BigInteger("21552347002471831326081673315959198890815298992330888454662334499946296341989387947872761885158213982937463940347052051774843037018871")));
        assertThat(point.getY().getInteger(), is(new BigInteger("357373306191655299280537582309534138704679428048844536962096044990522311544407707633625075281628144531544209749465261583401063761590143")));
    }
    ...
    public void success_ScalarMultipleBasePoint_8() {
        ...
        assertThat(point.getX().getInteger(), is(new BigInteger("596076689965651660022516817574257859767655189303710608336194617254375604050911414190272256792693764900933801964043657940361520281271776")));
        assertThat(point.getY().getInteger(), is(new BigInteger("565960773781129488052659607211963370179410097582298438377162450965951398045899014271088170591759362241006993622586109875821902761156763")));
    }
    ...
    public void success_ScalarMultipleBasePoint_9() {
        ...
        assertThat(point.getX().getInteger(), is(new BigInteger("678819586033147925281023223806960408804378601126531157763570688900376738103095651143762799384400423222857151421219751020550555632887915")));
        assertThat(point.getY().getInteger(), is(new BigInteger("60696086077381741094032748984832537947444053808169978921575679174195124930944594569279421079811560196531757705827406107516052224374095")));
    }
    ...
    public void success_ScalarMultipleBasePoint_10() {
        ...
        assertThat(point.getX().getInteger(), is(new BigInteger("338669802554017338090741842335737823113336653904160109397584018105059385206196637853257117971041875208554805602850382915119972512247869")));
        assertThat(point.getY().getInteger(), is(new BigInteger("219150861381236143450521108354203769270679720218000652369136137699333671138749674479139795638088562049448210382871218396511167516106599")));
    }
    ...
    public void success_ScalarMultipleBasePoint_47218412417289471() {
        ...
        assertThat(point.getX().getInteger(), is(new BigInteger("706962928758557286146477331671104898387376109527551747178149994986356021591923299562304281357717856573928016518683667087189558043425510")));
        assertThat(point.getY().getInteger(), is(new BigInteger("279992018783083106764723692021891527281730215435161171351137438665373473663265784536951370748332118946047677007832925697871713328581900")));
    }
